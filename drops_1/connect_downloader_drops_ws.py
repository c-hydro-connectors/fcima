...
Running on command-line with java 8
...
from lib_utils_apps_time import convertTimeFrequency

from lib_db_drops_apps_generic import initDropsDB
from lib_db_drops_apps_sensor import getSensorType, getSensorRegistry, getSensorData
from lib_db_drops_utils_sensor_ws import parseSensorData, parseSensorRegistry, createSensorDataFrame
from lib_db_drops_utils_io import writeSensorDataFrame
# -------------------------------------------------------------------------------------
